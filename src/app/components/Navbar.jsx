...
import { Play, Search, Bell, User, Menu, X, ChevronDown, BookOpen, Video, Award, Users, LogOut, Home } from 'lucide-react';
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        {isAuthenticated ? (
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={logout}
                                className="px-6 py-2 bg-gradient-to-r from-red-600 to-red-500 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center space-x-2"
                            >
                            ...
                            <div className="px-4 pt-4 border-t border-gray-100">
                                {isAuthenticated ? (
                                    <motion.button
                                        whileTap={{ scale: 0.95 }}
                                        onClick={logout}
                                        className="w-full px-6 py-3 bg-gradient-to-r from-red-600 to-red-500 text-white font-semibold rounded-lg shadow-md flex items-center justify-center space-x-2"
                                    >
                                        <LogOut className="w-4 h-4" />
                                        <span>Logout</span>
                                    </motion.button>
